...
vlog -work work mydcm_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax mydcm_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.mydcm_tb work.glbl
