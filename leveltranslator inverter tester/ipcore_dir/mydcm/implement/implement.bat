...
xst -ifn xst.scr
move mydcm_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\mydcm_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc mydcm_exdes.ucf mydcm_exdes

echo 'Running map'
map -timing -pr b mydcm_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm mydcm_exdes -w routed.ncd routed.v
cd ..
